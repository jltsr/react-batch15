...
export default function ProjectAssignmentEditForm(props) {
    const [assigment, setAssignment] = useState([])
    useEffect(() => {
        Api.findOneProjectAssignment(props.id.assignID).then(data => {
            setAssignment(data)
        })
         ...
         <form onSubmit={props.onSubmit}>
            <div class="mb-6">
                ...
                <select class="form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-bg-gray-50 bg-clip-padding bg-no-repeat border border-solid border-gray-300
                    ...
                    <option>{assigment.pras_proj_id}</option>
                    {
            ...
            <div class="mb-6">
                ...
                <select class="form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-bg-gray-50 bg-clip-padding bg-no-repeat border border-solid border-gray-300
                    ...
                    <option>{assigment.pras_employee_id} </option>
                    {
            ...
            <div class="grid gap-6 mb-6 lg:grid-cols-2">
                <div >
                    ...
                    <input type="text" placeholder={assigment.pras_startdate}
                ...
                <div >
                    ...
                    <input type="text" placeholder={assigment.pras_enddate}
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="mb-6">
                ...
                <input type="text" placeholder={assigment.pras_status}
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
