...
import {GetJobRequest} from '../Redux-saga/Action/JobAction'
import {GetDepartmentRequest} from '../Redux-saga/Action/DepartmentAction'
                                ...
                                <tbody className="overscroll-auto md:overscroll-contain">
                                    {
                                        employees&&employees.map( emp => (
                                            ...
                                            <button onClick={() => onClick({empID: emp.employee_id})}
                                            type="button"
